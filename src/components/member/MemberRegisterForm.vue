  ...
  <div class="container">
    ...
    <form id="memberForm" @submit.prevent="memberRegister">
        ...
        <div class="mb-3">
          ...
          <input type="password" class="form-control pwChk" id="password" ref="pwRef" name="password" placeholder="비밀번호" v-model="registerData.password" required>
        ...
        <div class="mb-3">
          ...
          <input type="tel" class="form-control" id="handphone" name="phoneNumber" ref="phoneRef" placeholder="010-0000-0000" maxlength="13" v-model="registerData.phoneNumber" required>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="postCode" name="postCode" ref="postCodeRef" placeholder="우편번호" v-model="registerData.postCode" required maxlength="5">
